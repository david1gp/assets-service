  ...
  return (
    ...
    >
      <div class="flex items-start justify-between gap-2">
        ...
        <Show when={p.project.archiveState !== undefined && p.project.archiveState !== "active"}>
          <Badge variant="subtle" class="shrink-0" data-testid="project-archived">
            {ttc("Archived", "Archiviert")}
          </Badge>
        </Show>
      </div>
