...
export const serviceConfigSchema = v.strictObject({
  ...
  r2DevelopmentBucket: v.optional(v.pipe(v.string(), v.minLength(1))),
  r2ProductionBucket: v.optional(v.pipe(v.string(), v.minLength(1))),
  r2Endpoint: v.pipe(v.string(), v.url()),
  r2PublicBaseUrl: v.pipe(v.string(), v.url()),
  r2DevelopmentPublicBaseUrl: v.optional(v.pipe(v.string(), v.url())),
  r2ProductionPublicBaseUrl: v.optional(v.pipe(v.string(), v.url())),
